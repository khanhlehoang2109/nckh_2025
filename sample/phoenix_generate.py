...
def main():
    ...
    assert args.guidance_param == 5.5, "Inference on Phoenix requires guidance_param=5.5"
...
# !python -m sample.generate --model_path /kaggle/working/mdm/save/phoenix_OURs_6blocks_drop25_exp2/model000100000.pt \
# --num_repetitions 1 \
# --guidance_param 5.5 \
# --motion_length 5 \
# --num_samples 10